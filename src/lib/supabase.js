...
export const getProducts = async (filters = {}) => {
  ...
  const dbProducts = (data || []).map(p => {
    ...
    return {
      ...
      colors: isApparel ? ["Black", "White", "Red", "Blue", "Pink"] : [],
...
export const MOCK_CUSTOM_PRODUCTS = [
  ...
  },
  {
    ...
    stock: 999,
    isCustom: true,
    description: "Light-up concert wristband. Choose from White, Blue, Pink, or Green neon LED flash colors. Sound-activated options available."
  }
];
